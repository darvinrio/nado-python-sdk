...
class QueryStatusParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.STATUS.value
...
class QueryContractsParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.CONTRACTS.value
...
class QueryNoncesParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.NONCES.value
    address: str
...
class QueryOrderParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.ORDER.value
    product_id: int
    digest: str
...
class QueryIsolatedPositionsParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.ISOLATED_POSITIONS.value
    subaccount: str
...
class QuerySubaccountInfoParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.SUBACCOUNT_INFO.value
    subaccount: str
...
class QuerySubaccountOpenOrdersParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.SUBACCOUNT_ORDERS.value
    product_id: int
    sender: str
...
class QuerySubaccountMultiProductOpenOrdersParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.ORDERS.value
...
class QueryMarketLiquidityParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.MARKET_LIQUIDITY.value
    product_id: int
    depth: int
...
class QuerySymbolsParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.SYMBOLS.value
...
class QueryAllProductsParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.ALL_PRODUCTS.value
...
class QueryMarketPriceParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.MARKET_PRICE.value
    product_id: int
...
class QueryMaxOrderSizeParams(SpotLeverageSerializerMixin):
    ...
    type: ClassVar[str] = EngineQueryType.MAX_ORDER_SIZE.value
    sender: str
    product_id: int
    price_x18: str
...
class QueryMaxWithdrawableParams(SpotLeverageSerializerMixin):
    ...
    type: ClassVar[str] = EngineQueryType.MAX_WITHDRAWABLE.value
    sender: str
    product_id: int
...
class QueryMaxLpMintableParams(SpotLeverageSerializerMixin):
    ...
    type: ClassVar[str] = EngineQueryType.MAX_NLP_MINTABLE.value
    sender: str
    product_id: int
...
class QueryFeeRatesParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.FEE_RATES.value
    sender: str
...
class QueryHealthGroupsParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.HEALTH_GROUPS.value
...
class QueryLinkedSignerParams(NadoBaseModel):
    ...
    type: ClassVar[str] = EngineQueryType.LINKED_SIGNER.value
    subaccount: str
